...
namespace PCSportsCards.Data.Infrastructure
{
    public static class EFExtensions
    {
        ...
        /// <returns></returns>
        public static DbCommand WithSqlParam(this DbCommand cmd, List<SqlParameter> parameter)
        {
        ...
        private static IList<T> MapToList<T>(this DbDataReader dr)
        {
            ...
            if (dr.HasRows)
            {
                while (dr.Read())
                {
                    ...
                    foreach (var prop in props.Where(i => colMapping.Any(x => x.Key == i.Name.ToLower())))
                    {
